                        ...
                        <div class='x_title no-padding-lr'>
                            <div class='clearfix'>
                                ...
                                <div class='col-md-4 col-sm-4 no-padding'>
                                    ...
                                    <button type = 'button' id = 'modifybtn' style= 'display: none; margin-left: 10px; margin-right: 10px;' id= 'modifybtn' onclick= 'allowEditObj();' class='btn btn-success btn-blue-success pull-right' ><?= _('MODIFICA') ?></button>
                                    <button type = 'button' id = 'undobtn' style= 'display: none; margin-left: 10px; margin-right: 10px;' id= 'undobtn' onclick= 'undoObj();' class='btn btn-warning btn-yellow-warning pull-right' ><?= _('ANNULLA') ?></button>
