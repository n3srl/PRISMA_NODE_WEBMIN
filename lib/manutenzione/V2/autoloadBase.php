...
$dir = $_SERVER['DOCUMENT_ROOT']. "/lib/manutenzione/V2/model";
if(file_exists($dir)) {
...
$dir = $_SERVER['DOCUMENT_ROOT']. "/lib/manutenzione/V2/logic";
if(file_exists($dir)) {
	$files_tmp = scandir($dir);
	$files = array();
	foreach ($files_tmp as $key => $value)
...
$dir = $_SERVER['DOCUMENT_ROOT']. "/lib/manutenzione/V2/logic/api";
if(file_exists($dir)){
	$files_tmp = scandir($dir);
	$files = array();
	foreach ($files_tmp as $key => $value)
